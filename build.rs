...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .allowlist_type("ServerHandler")
        .allowlist_function("mumble_handler_.*")
        .allowlist_function("mumble_connect")
        .allowlist_function("mumble_init")
        .allowlist_function("mumble_process_events")
        .allowlist_type("on_connected_callback")
        .allowlist_type("on_disconnected_callback")
        .allowlist_type("on_error_callback")
        .allowlist_function("mumble_connect")
